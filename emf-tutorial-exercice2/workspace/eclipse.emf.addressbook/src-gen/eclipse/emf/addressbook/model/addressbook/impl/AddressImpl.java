...
public class AddressImpl extends MinimalEObjectImpl.Container implements Address {
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.ADDRESS__NUMBER, oldNumber,
					number));
	}
	...
	public void setStreet(String newStreet) {
		...
		street = newStreet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.ADDRESS__STREET, oldStreet,
					street));
	}
